public class Diccionarios
{
    ...
    {
         Dictionary<string, string> traduccion = new Dictionary<string, string>();           //Creamos un diccionario con el tipo de dato que tendrá la clave y el tipo de dato que tendrá el valor
